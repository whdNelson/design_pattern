...
public class PictureController {
    ...
    @PostMapping
    public void picChange(@RequestParam(value = "file") MultipartFile multipartFile) throws IOException {

        String base = "love";//将会用这个字符串里的字符填充图片
        BufferedImage image = ImageIO.read(multipartFile.getInputStream());//读入图片，并用图片缓冲区对象来接收
